...
var GroupSizeContext = React5.createContext(void 0);
var ButtonGroup = (props) => {
  ...
  return React5.createElement(GroupSizeContext.Provider, {
    value: size
  }, React5.createElement("div", Object.assign({}, others, {
    className: classes
  })));
};
...
var Search = React10.forwardRef((props, ref) => {
  const {
    prefixCls: customizePrefixCls,
  ...
  const composedRef = React10.useRef(false);
  ...
  const searchIcon = typeof enterButton === "boolean" ? React10.createElement(SearchOutlined_default, null) : null;
  ...
  if (isAntdButton || enterButtonAsElement.type === "button") {
    ...
    button = React10.createElement(button_default2, {
      className: btnClassName,
  ...
  return React10.createElement(Input_default, Object.assign({
...
//# sourceMappingURL=chunk-TYVG5O73.js.map
